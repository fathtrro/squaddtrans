...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4">
    <div class="text-center">
        ...
        <h2 class="text-3xl font-semibold text-gray-700 mb-2">Oops... Something want wrong.</h2>
        <p class="text-gray-500 text-lg mb-8">We can't find the page you're looking for.</p>
