...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/jpeg" href="{{ asset('images/lg.png') }}">
...
<body class="bg-gray-50">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar"
            ...
            <!-- Logo -->
            <div
                class="sticky top-0 bg-white p-4 sm:p-6 border-b border-gray-200 flex items-center justify-between z-10">
                <div class="flex items-center space-x-3 min-w-0">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <!-- Header -->
            <header
                class="bg-white border-b border-gray-200 px-3 sm:px-6 lg:px-8 py-3 sm:py-4 sticky top-0 z-30 shadow-sm">
                <div class="flex items-center justify-between gap-3 sm:gap-4">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3 lg:gap-6 flex-shrink-0">
                        ...
                        <a href="{{ route('admin.inbox.index') }}"
                            class="relative p-2 text-gray-400 hover:text-yellow-600 hover:bg-gray-100 rounded-lg transition-colors group flex-shrink-0">
                            ...
                            @endif
                            <span
                                class="hidden sm:block absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-gray-800 text-white text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50">
                                Inbox ({{ $unreadCount }})
                            </span>
                        </a>
                        ...
                        <div class="relative group flex-shrink-0">
                            <button type="button"
                                class="flex items-center gap-2 sm:gap-3 focus:outline-none focus:ring-2 focus:ring-yellow-400 rounded-lg px-2 py-1">
                                ...
                                <div class="hidden lg:block text-left">
                                    <p class="text-sm font-semibold text-gray-800 whitespace-nowrap">
                                        {{ Auth::user()->name ?? 'Admin Squad' }}</p>
                                    <p class="text-xs text-gray-500 whitespace-nowrap">
                                        {{ Auth::user()->type ?? 'Super Admin' }}</p>
                                </div>
                            </button>

                            <!-- Dropdown Menu -->
                            <div
                                class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 border border-gray-100 py-1">
                                ...
                                <form method="POST" action="{{ route('logout') }}" class="block">
                                    @csrf
                                    <button type="submit"
                                        class="w-full flex items-center gap-2 text-left px-4 py-2 text-sm text-gray-700 hover:bg-red-50 hover:text-red-600 transition-colors">
