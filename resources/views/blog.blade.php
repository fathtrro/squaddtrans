...
════════════════════════════════════ */
        ...
        .g-tips {
            background: linear-gradient(135deg, #14532d, #15803d, #86efac);
        }

        .g-guide {
            background: linear-gradient(135deg, #7c2d12, #c2410c, #fb923c);
        }

        .g-promo {
            background: linear-gradient(135deg, #4a1d96, #7e22ce, #c084fc);
        }

        .g-news {
            background: linear-gradient(135deg, #1e1b4b, #3730a3, #818cf8);
        }

        .g-dark {
            background: linear-gradient(135deg, #111, #2d2d2d, #555);
        }
        ...
        .bl-feat-sm .bl-feat-img {
            aspect-ratio: 16/7;
        }

        .bl-feat-sm .bl-feat-body {
            padding: 16px 18px 18px;
        }

        .bl-feat-sm .bl-feat-title {
            font-size: 14.5px;
            margin-bottom: 10px;
        }
...
════════════════════════════════════ */
        ...
        .bl-list-item:hover .bl-list-num {
            color: var(--amber-l);
        }
...
════════════════════════════════════ */
        ...
        .bl-pop-item:hover .bl-pop-title {
            color: var(--amber-d);
        }
...
════════════════════════════════════ */
        ...
        /* entrance animation */
        .bl-fade {
            animation: blFade .5s cubic-bezier(.22, 1, .36, 1) both;
        }
            ...
            <div class="bl-wrap">
                <div class="bl-hero-inner">
                    <div>
                        ...
                        <p class="bl-hero-sub">
                            Tips berkendara, destinasi wisata terbaik, promo terkini, dan cerita perjalanan dari
                            komunitas SquadTrans.
                        </p>
                    </div>
                        ...
                        <div class="bl-featured">
                            ...
                            <a href="#" class="bl-feat-main bl-fade">
                                ...
                                <div class="bl-feat-body">
                                    ...
                                    <p class="bl-feat-excerpt">
                                        Jawa menyimpan begitu banyak surga tersembunyi yang belum banyak terjamah
                                        wisatawan. Dari pantai biru di ujung timur hingga kebun teh yang menghijau di
                                        dataran tinggi — semua bisa Anda jelajahi dengan mudah bersama SquadTrans.
                                    </p>
                            ...
                            <a href="#" class="bl-feat-sm bl-fade">
                                ...
                                <div class="bl-feat-body">
                                    ...
                                    <h3 class="bl-feat-title">Persiapan Road Trip Panjang: Checklist yang Sering
                                        Dilupakan</h3>
                            ...
                            @php
                                $articles = [
                                    [
                                        ...
                                        'tag' => 'Panduan Sewa',
                                        'date' => '27 Feb',
                                        'title' => 'Panduan Lengkap Sewa Mobil Harian untuk Pemula',
                                        'author' => 'Rafi A',
                                        'time' => '5 mnt',
                                    ],
                                    [
                                        ...
                                        'date' => '24 Feb',
                                        'title' => 'Menjelajahi Bali Timur: Rute 3 Hari yang Sempurna',
                                        'author' => 'Siti N',
                                        'time' => '7 mnt',
                                    ],
                                    [
                                        ...
                                        'tag' => 'Tips Berkendara',
                                        'date' => '20 Feb',
                                        'title' => 'Cara Memilih Kendaraan yang Tepat untuk Liburan Keluarga',
                                        'author' => 'Dian R',
                                        'time' => '4 mnt',
                                    ],
                                    [
                                        ...
                                        'tag' => 'Berita',
                                        'date' => '17 Feb',
                                        'title' => 'SquadTrans Kini Hadir di Makassar dan Manado',
                                        'author' => 'Admin',
                                        'time' => '3 mnt',
                                    ],
                                    [
                                        'g' => 'g-dark',
                                        'tag' => 'Cerita Pelanggan',
                                        'date' => '14 Feb',
                                        'title' => 'Perjalanan Romantis Malang–Bromo: Cerita dari Pasangan Muda',
                                        'author' => 'Lia K',
                                        'time' => '6 mnt',
                                    ],
                                    [
                                        ...
                                        'tag' => 'Panduan Sewa',
                                        'date' => '10 Feb',
                                        'title' => 'Apa Itu Sewa Lepas Kunci? Keuntungan dan Syaratnya',
                                        'author' => 'Rafi A',
                                        'time' => '5 mnt',
                                    ],
                                ];
                            ...
                            @foreach ($articles as $i => $a)
                                <a href="#" class="bl-card bl-fade">
                                    <div class="bl-card-img {{ $a['g'] }}">
                                        <div
                                            style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:48px;opacity:.1;font-family:'Playfair Display',serif;font-style:italic;color:#fff">
                                            {{ $i + 1 }}</div>
                                    </div>
                            ...
                            @php
                                $list = [
                                    [
                                        'n' => '01',
                                        'tag' => 'Tips Berkendara',
                                        'title' => '10 Kesalahan Umum Saat Berkendara di Luar Kota',
                                        'date' => '8 Feb 2025',
                                        'time' => '6 mnt',
                                    ],
                                    [
                                        'n' => '02',
                                        'tag' => 'Destinasi Wisata',
                                        'title' => 'Wisata Alam Bromo: Tips Terbaik agar Tak Kecewa',
                                        'date' => '4 Feb 2025',
                                        'time' => '8 mnt',
                                    ],
                                    [
                                        ...
                                        'tag' => 'Panduan Sewa',
                                        'title' =>
                                            'Perbedaan Sewa Harian, Mingguan, dan Bulanan: Mana yang Lebih Hemat?',
                                        'date' => '1 Feb 2025',
                                        'time' => '5 mnt',
                                    ],
                                    [
                                        'n' => '04',
                                        'tag' => 'Promo & Info',
                                        'title' => 'SquadTrans Loyalty: Cara Kumpulkan & Tukarkan Poin Anda',
                                        'date' => '26 Jan 2025',
                                        'time' => '4 mnt',
                                    ],
                                ];
                                ...
                                <a href="#" class="bl-list-item">
                                    ...
                                    <div>
                                        ...
                                        <div class="bl-list-meta">
                                            <span class="bl-tag"
                                                style="font-size:9.5px;padding:3px 9px">{{ $item['tag'] }}</span>
                                            <span>{{ $item['date'] }}</span>
                    ...
                    <aside class="bl-sidebar">
                        ...
                        <div class="bl-widget">
                            ...
                            <div class="bl-popular">
                                @foreach ([['n' => '1', 't' => '10 Destinasi Tersembunyi di Jawa yang Wajib Dikunjungi', 'm' => '12.4k pembaca'], ['n' => '2', 't' => 'Panduan Lengkap Sewa Mobil Harian untuk Pemula', 'm' => '9.1k pembaca'], ['n' => '3', 't' => 'Cara Memilih Kendaraan yang Tepat untuk Liburan Keluarga', 'm' => '7.8k pembaca'], ['n' => '4', 't' => 'Promo Lebaran 2025: Diskon 30% Sewa Mingguan', 'm' => '6.2k pembaca']] as $p)
                        ...
                        <div class="bl-newsletter">
                            ...
                            <p class="bl-nl-desc">Dapatkan tips perjalanan, promo eksklusif, dan inspirasi wisata
