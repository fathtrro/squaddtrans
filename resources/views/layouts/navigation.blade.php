    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="flex items-center space-x-3 group">
                <div class="relative">
                    <div
                        class="absolute inset-0 bg-yellow-400 rounded-lg blur-md opacity-0 group-hover:opacity-30 transition-opacity duration-300">
                    </div>
                ...
                <span class="text-2xl font-bold tracking-tight">
                    ...
                    <span
                        class="text-yellow-500 bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text">TRANS</span>
                </span>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-1 font-medium">
                <a href="/"
                    ...
                    <span
                        class="absolute bottom-0 left-0 w-0 h-0.5 bg-yellow-500 group-hover:w-full transition-all duration-300"></span>
                </a>
                    ...
                    <div class="relative" x-data="{ openProfile: false }">
                        <button @click="openProfile = !openProfile"
                            ...
                            <svg :class="openProfile ? 'rotate-180' : ''"
                                class="w-4 h-4 text-gray-500 transition-transform duration-300" fill="none"
            ...
            <div class="md:hidden">
                <button @click="open = !open" class="p-2 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                    <svg class="w-6 h-6 transition-transform duration-300" :class="open ? 'rotate-90' : ''"
