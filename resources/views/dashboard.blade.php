<x-app-layout>
    ...
    <div class="bg-gray-50">
        ...
        {{-- Reviews Section --}}
        <section class="py-24 bg-slate-50" id="ulasan">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
                    <div>
                        ...
                        <h2 class="section-title">Ulasan Dari Pelanggan Kami</h2>
                    </div>

                    <a href="{{ route('reviews.create') }}"
                        class="bg-yellow-600 text-white font-bold py-3 px-6 rounded-xl hover:bg-yellow-700 transition-colors flex items-center gap-2 w-fit">
                            ...
                            <div
                                ...
                                <div class="p-8">
                                    ...
                                    <div class="flex items-center gap-3 border-t border-slate-100 pt-4">
                                        <div
                                            class="w-12 h-12 bg-yellow-600/10 rounded-full flex items-center justify-center flex-shrink-0">
                                            <i class="fa-solid fa-user text-yellow-600 text-lg"></i>
                                        </div>
                                        <div>
                ...
                @else
                    <div class="text-center py-16 bg-white rounded-3xl border border-slate-100">
                        <div class="mb-4">
                            <i class="fa-solid fa-comments text-6xl text-slate-300"></i>
                        </div>
                        <p class="text-gray-500 text-lg mb-4">
                            Belum ada ulasan. Jadilah yang pertama memberikan ulasan!
                        </p>
                        <a href="{{ route('reviews.create') }}"
                            class="bg-yellow-600 text-white font-bold py-3 px-8 rounded-xl hover:bg-yellow-700 transition-colors inline-flex items-center gap-2">
                            <i class="fa-solid fa-plus text-sm"></i>
