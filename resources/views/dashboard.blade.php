...
@keyframes bl{0%,100%{opacity:1;transform:scale(1)}50%{opacity:.4;transform:scale(.75)}}
...
<header class="pg relative w-full overflow-hidden"
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:56px;align-items:center;width:100%;">
            ...
            <div style="padding-right:8px;">
                ...
                <div class="fu1"
                    ...
                    <span style="color:#fbbf24;font-size:10.5px;font-weight:700;
                ...
                <div class="fu3" style="display:flex;gap:28px;">
                    <div>
                        <p style="font-family:'Syne',sans-serif;font-size:1.6rem;font-weight:800;
                                  color:#f59e0b;margin:0;line-height:1;">500+</p>
                        <p style="font-size:11px;color:rgba(255,255,255,.4);margin:4px 0 0;
                                  letter-spacing:.04em;">Unit Armada</p>
                    </div>
                    <div style="width:1px;background:rgba(255,255,255,.12);"></div>
                    <div>
                        <p style="font-family:'Syne',sans-serif;font-size:1.6rem;font-weight:800;
                                  color:#f59e0b;margin:0;line-height:1;">10K+</p>
                        <p style="font-size:11px;color:rgba(255,255,255,.4);margin:4px 0 0;
                                  letter-spacing:.04em;">Pelanggan Puas</p>
                    </div>
                    <div style="width:1px;background:rgba(255,255,255,.12);"></div>
                    <div>
                        <p style="font-family:'Syne',sans-serif;font-size:1.6rem;font-weight:800;
                                  color:#f59e0b;margin:0;line-height:1;">5★</p>
                        <p style="font-size:11px;color:rgba(255,255,255,.4);margin:4px 0 0;
                                  letter-spacing:.04em;">Rating</p>
                    </div>
                </div>
            </div>
                    ...
                    <div style="position:relative;
                        ...
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
                            <div style="display:flex;gap:4px;
                                        ...
                                        border-radius:14px;">
                                <button id="btn-lepas-kunci"
                                        onclick="switchHeroTab('lepas-kunci')"
                                ...
                                <button id="btn-carter"
                                        onclick="switchHeroTab('carter')"
                                        style="padding:8px 18px;border-radius:10px;
                                               font-size:12.5px;font-weight:700;
                                               border:none;cursor:pointer;
                                               font-family:'DM Sans',sans-serif;
                            ...
                            <form id="dashboardDateForm">
                                ...
                                <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px;">
                                    ...
                                    <div style="position:relative;
                                        ...
                                        <span style="display:block;font-size:8.5px;font-weight:700;
                                                     letter-spacing:.16em;text-transform:uppercase;
                                                     color:rgba(255,255,255,.45);margin-bottom:8px;">
                                            Tanggal Mulai
                                        </span>
                                        <input type="datetime-local"
                                               id="dashboardStartDateTime"
                                        ...
                                        <div style="pointer-events:none;">
                                            ...
                                            <p id="startTimeLine"
                                               style="font-size:11.5px;
                                                      ...
                                                      margin:4px 0 0;line-height:1;">—</p>
                                        </div>
                                    </div>
                                    ...
                                    <div style="background:rgba(255,255,255,.08);
                                        ...
                                        <p style="font-size:10.5px;color:rgba(255,255,255,.38);
                        ...
                        <div id="tab-carter" style="display:none;">
                            <p style="color:rgba(255,255,255,.6);font-size:13.5px;
    ...
    <div class="absolute bottom-7 left-1/2 -translate-x-1/2 z-10"
        ...
        <span style="font-size:.58rem;letter-spacing:.18em;color:rgba(255,255,255,.25);
...
(function(){
    ...
    window.switchHeroTab = function(tab) {
        ...
        if (isLK) {
            btnLK.style.cssText = 'padding:8px 20px;border-radius:10px;font-size:13px;font-weight:700;border:none;cursor:pointer;font-family:\'DM Sans\',sans-serif;background:linear-gradient(135deg,#f59e0b,#d97706);color:#1a1200;box-shadow:0 2px 12px rgba(245,158,11,.35);transition:all .2s;';
            btnCT.style.cssText = 'padding:8px 20px;border-radius:10px;font-size:13px;font-weight:700;border:none;cursor:pointer;font-family:\'DM Sans\',sans-serif;background:transparent;color:rgb(100,116,139);transition:all .2s;';
        } else {
            btnCT.style.cssText = 'padding:8px 20px;border-radius:10px;font-size:13px;font-weight:700;border:none;cursor:pointer;font-family:\'DM Sans\',sans-serif;background:linear-gradient(135deg,#f59e0b,#d97706);color:#1a1200;box-shadow:0 2px 12px rgba(245,158,11,.35);transition:all .2s;';
            btnLK.style.cssText = 'padding:8px 20px;border-radius:10px;font-size:13px;font-weight:700;border:none;cursor:pointer;font-family:\'DM Sans\',sans-serif;background:transparent;color:rgb(100,116,139);transition:all .2s;';
        }
    };
    ...
    setDefaults();
    startInput.addEventListener('change',function(){updateStart();calcEnd();});
    ...
    <div class="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
            ...
            $features = [
                ...
                ['icon'=>'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z','title'=>'Teknologi Terpercaya','desc'=>'Terhubung dengan teknologi yang memastikan ribuan kendaraan beroperasi secara efisien dan real-time.'],
                ...
                @else
                    <div class="w-full h-44 flex items-center justify-center" style="background:#fef9ee;">
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none"
                            ...
                            <path d="M19 17H5m14 0a2 2 0 002-2v-4a2 2 0 00-2-2h-1.172a2 2 0 01-1.414-.586L14 6.586A2 2 0 0012.586 6H6a2 2 0 00-2 2v7a2 2 0 002 2m13 0v2a2 2 0 01-2 2H7a2 2 0 01-2-2v-2"/>
                        </svg>
                    </div>
                @endif
                    ...
                    <div class="flex items-center gap-3 border-t border-slate-100 pt-4">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs text-slate-400 truncate">
                                {{ $review->booking->car->brand ?? '' }} {{ $review->booking->car->name ?? '' }}
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div style="padding:2rem;position:relative;">
        ...
        <form action="{{ route('reviews.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="flex gap-3 pt-1">
                ...
                <button type="submit"
                        class="flex-1 py-3 font-semibold rounded-xl text-sm text-white transition"
